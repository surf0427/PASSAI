              ...
              return (
                ...
                >
                  <div className={fieldClass}>
                    <label className={labelClass}>留学先 <span className="text-red-500">*</span></label>
                    <input type="text" className={hasError ? inputErrorClass : inputClass} value={activity.destination}
                      onChange={(e) => onUpdate(index, 'destination', e.target.value)}
                      placeholder="例：アメリカ・ボストン" />
                  </div>
                  <div className={fieldClass}>
                    <label className={labelClass}>プログラム内容</label>
                    <input type="text" className={inputClass} value={activity.programContent}
                      onChange={(e) => onUpdate(index, 'programContent', e.target.value)}
                      placeholder="例：語学研修プログラム" />
                  </div>
                  <div className={fieldClass}>
                    <label className={labelClass}>使用言語</label>
                    <input type="text" className={inputClass} value={activity.language}
