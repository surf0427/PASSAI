    ...
    <section className="mb-4 border border-gray-200 rounded-xl bg-white overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3">
        <button
          ...
          aria-controls="contest-activity-section-content"
      ...
      {isOpen && (
        <div id="contest-activity-section-content" className="border-t border-gray-100 px-4 pt-3 pb-4">
          {errors && errors.length > 0 && (
          ...
          <div className="space-y-4">
            {activities.map((activity, index) => {
              ...
              return (
                ...
                >
                  <FormField label="コンテスト名" required>
                    <Input
                      type="text"
                      value={activity.contestName}
