...
function r1Register(): void {
  ...
  // ★ E-S49（human ruling / E-S39 を一部 supersede）★
  ...
  const wireCodecs = spineFiles
    ...
    .sort();
  check(
    'active な device-claim wire codec は sync/claim/** だけ（E-S49）',
  ...
  // ★ 退役した wire format が active code に残っていないこと（E-S49）★
  ...
  check(
    'active code に退役 wire format（esy1）が 0 箇所（E-S49）',
